...
class GeneralPhysicianBookingView extends StatefulWidget {
  const GeneralPhysicianBookingView({super.key});

  @override
  State<GeneralPhysicianBookingView> createState() =>
      _GeneralPhysicianBookingViewState();
}

class _GeneralPhysicianBookingViewState
    extends State<GeneralPhysicianBookingView> {
