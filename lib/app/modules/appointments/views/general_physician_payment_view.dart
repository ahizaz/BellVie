...
class GeneralPhysicianPaymentView extends StatefulWidget {
  const GeneralPhysicianPaymentView({super.key});

  @override
  State<GeneralPhysicianPaymentView> createState() =>
      _GeneralPhysicianPaymentViewState();
}

class _GeneralPhysicianPaymentViewState
    extends State<GeneralPhysicianPaymentView> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      final response = await _apiService.post(
        path: '/api/v1/top-doctor/payments/',
