...
class _AppointmentPaymentViewState extends State<AppointmentPaymentView> {
    ...
    if (transactionId.isEmpty) {
      AppLoader.showError(
        _paymentMethod == 'banking'
            ? 'Please enter last 4 digit of banking.'
  ...
  Widget build(BuildContext context) {
    final isBanking = _paymentMethod == 'banking';
      ...
      body: ListView(
        ...
        children: [
          ...
          _InputField(
            ...
            label: isBanking ? 'Last 4 Digit of Banking' : 'transaction_id'.tr,
            hintText: isBanking
                ? 'Enter last 4 digit of banking'
                : 'enter_transaction_id'.tr,
            textInputAction: TextInputAction.done,
            keyboardType: isBanking ? TextInputType.number : TextInputType.text,
            maxLength: isBanking ? 4 : null,
          ),
