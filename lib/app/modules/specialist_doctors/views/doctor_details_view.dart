...
class DoctorDetailsView extends StatelessWidget {
  ...
  String _phoneNumberOnly(String value) {
    return value.replaceAll(RegExp(r'[^0-9+]'), '');
  }

  Future<void> _callPhone(String number) async {
    final phone = _phoneNumberOnly(number);
  ...
  Widget _heroAvatar(String imageUrl, String name, String designation) {
    final bool hasDesignation = designation.trim().isNotEmpty &&
  ...
  Widget _callableContactCard(String line) {
    return GestureDetector(
      onTap: () => _callPhone(line),
      child: Container(
        width: double.infinity,
          ...
          : FutureBuilder<Map<String, dynamic>>(
              ...
              builder: (context, snapshot) {
                ...
                final name = (lang == 'bn' &&
                    ...
                    : _textValue(data['name_en'] ?? data['name']);
                ...
                final designation = (lang == 'bn' &&
                    ...
                    : _textValue(data['designation_en'] ?? data['designation']);
                ...
                final details = (lang == 'bn' &&
                        (data['doctor_details_bn']
                                ?.toString()
                                .trim()
                                .isNotEmpty ??
                            false))
                    ...
                    : _textValue(
                        data['doctor_details_en'] ?? data['doctor_details'],
                        fallback: 'no_additional_details_available'.tr,
                      );
