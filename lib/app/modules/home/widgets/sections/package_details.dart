...
//               ),
//             child: isProbashi
//       ? _buildProbashiList(_probashiRowKeys)     // ← এই লাইন
//       : _buildPremiumVerticalPlans(),
//             ),
//           ],
//         ),
...
//   ['hospitalization', '50,000 (BDT 5000/day, up to 5 days in a row)'],
//   ['telemedicine_24_7', '24/7 Unlimited Audio & Video Doctor Consultancy (Up to Six member of Family)'],
//   ];
...
//             _buildProbashiCard(
//               label: rowKeys[i][0].tr,           // ← এখানে .tr যোগ হয়েছে
//               value: rowKeys[i][1],
//               emphasize: i == 0,
//               isNarrow: isNarrow,
//             ),
