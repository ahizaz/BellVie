...
class HomeController extends GetxController {
  ...
  // Discount Partner Details Cache
  final RxMap<int, Map<String, dynamic>> discountPartnerDetailsCache =
      <int, Map<String, dynamic>>{}.obs;

  Map<String, dynamic>? getCachedDiscountPartnerDetails(int id) {
    return discountPartnerDetailsCache[id];
  }

  void setCachedDiscountPartnerDetails(int id, Map<String, dynamic> data) {
    discountPartnerDetailsCache[id] = data;
  }
  ...
  Future<void> discountPartner() async {
  ...
  Future<void> specialDoctor() async {
