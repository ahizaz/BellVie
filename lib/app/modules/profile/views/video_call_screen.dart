...
import 'package:bellevie/app/modules/profile/views/call_button.dart';
...
class _VideoCallScreenState extends State<VideoCallScreen> {
  ...
  Future<void> _fetchAgoraToken() async {
    ...
    if (_appId == null || _appId!.isEmpty) {
      throw Exception('Agora app id not found');
    }

    if (_channelName == null || _channelName!.isEmpty) {
      throw Exception('Agora channel not found');
    }

    if (_token == null || _token!.isEmpty) {
      throw Exception('Agora token not found');
    }
  }
  ...
  Future<void> _initAgora() async {
    ...
    if (!cameraGranted || !micGranted) {
      throw Exception('Camera and microphone permission required');
    }
